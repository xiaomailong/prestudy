...
namespace lexertk
{
   ...
   public:
      ...
      inline bool process(const std::string& str)
      {
         ...
         eof_token_.set_operator(token_t::e_eof,s_end,s_end,base_itr);
         token_list_.clear();
   ...
   private:
      ...
      {
         while ((s_end != s_itr) && details::is_whitespace(*s_itr))
         {
            ++s_itr;
         }
      }
      ...
      inline void scan_token()
      {
         ...
         else if (details::is_operator_char(*s_itr))
         {
            scan_operator();
            return;
         }
         else if (details::is_letter(*s_itr))
         {
            scan_symbol();
            return;
         }
         else if (details::is_digit((*s_itr)) || ('.' == (*s_itr)))
         {
            scan_number();
            return;
         }
         ...
         {
            token_t t;
            t.set_error(token::e_error,s_itr,s_itr + 2);
      ...
      inline void scan_operator()
      {
         ...
         if ((s_itr + 1) != s_end)
         {
            ...
            {
               t.set_operator(ttype,s_itr,s_itr + 2,base_itr);
               token_list_.push_back(t);
               s_itr += 2;
               return;
            }
         ...
         if ('<' == *s_itr)
            t.set_operator(token_t::e_lt,s_itr,s_itr + 1,base_itr);
         else if ('>' == *s_itr)
            t.set_operator(token_t::e_gt,s_itr,s_itr + 1,base_itr);
         else
            t.set_operator(token_t::token_type(*s_itr),s_itr,s_itr + 1,base_itr);
      ...
      inline void scan_symbol()
      {
         ...
         while (
                (s_end != s_itr) &&
                (details::is_letter_or_digit(*s_itr) || ((*s_itr) == '_'))
               )
         {
            ++s_itr;
         }
         ...
         token_t t;
         t.set_symbol(begin,s_itr,base_itr);
         token_list_.push_back(t);
      }
         ...
         */
         ...
         while (s_end != s_itr)
         {
            if ('.' == (*s_itr))
            {
               if (dot_found)
               {
                  t.set_error(token::e_err_number,begin,s_itr,base_itr);
                  token_list_.push_back(t);
                  return;
               }
               dot_found = true;
            ...
            else if (details::imatch('e',(*s_itr)))
            {
            ...
            else if (e_found && details::is_sign(*s_itr))
            {
            ...
            else if (('.' != (*s_itr)) && !details::is_digit(*s_itr))
               break;
            else
               ++s_itr;
         }

         t.set_numeric(begin,s_itr,base_itr);
         token_list_.push_back(t);
         return;
      }
      ...
      inline void scan_string()
      {
         ...
         {
            t.set_error(token::e_err_string,begin,s_itr,base_itr);
            token_list_.push_back(t);
            return;
         }
         ...
         t.set_string(begin,s_itr,base_itr);
         token_list_.push_back(t);
   ...
   public:
      ...
      inline void process(generator& g)
      {
               ...
               case 4 :
                        {
                           ...
                           if (!operator()(t0,t1,t2,t3)) return;
                        }
                        break;
            }
         }
   ...
   namespace helper
   {
      ...
      void dump(lexertk::generator& generator)
      {
      ...
      public:
         ...
         {
            if (!t.value.empty() && lexertk::details::is_bracket(t.value[0]))
            {
               char c = t.value[0];
               ...
               else if (lexertk::details::is_right_bracket(c))
               {
                  if (stack_.empty())
                  {
                     state_ = false;
      ...
      class symbol_replacer : public lexertk::token_modifier
      {
      private:
         ...
         typedef std::map<std::string,std::string,ilesscompare> replace_map_t;
      ...
      public:
         ...
         bool add_replace(const std::string& target_symbol, const std::string& replace_symbol)
         {
            ...
            replace_map_[target_symbol] = replace_symbol;
            return true;
         }
      ...
      class sequnce_validator : public lexertk::token_scanner
      {
      private:
      ...
      public:
         ...
         : lexertk::token_scanner(2)
         {
            ...
            add_invalid(lexertk::token::e_symbol,lexertk::token::e_symbol);
            add_invalid(lexertk::token::e_string,lexertk::token::e_string);

            add_invalid(lexertk::token::e_number,lexertk::token::e_string);
            add_invalid(lexertk::token::e_symbol,lexertk::token::e_string);
            add_invalid(lexertk::token::e_string,lexertk::token::e_number);
            add_invalid(lexertk::token::e_string,lexertk::token::e_symbol);

            add_invalid(lexertk::token::e_number,lexertk::token::e_comma);
            add_invalid(lexertk::token::e_number,lexertk::token::e_colon);
            add_invalid(lexertk::token::e_symbol,lexertk::token::e_comma);
            add_invalid(lexertk::token::e_symbol,lexertk::token::e_colon);
            ...
            add_invalid_set2(lexertk::token::e_assign);
            add_invalid_set2(lexertk::token::e_shr);
            add_invalid_set2(lexertk::token::e_shl);
            add_invalid_set2(lexertk::token::e_lte);
            add_invalid_set2(lexertk::token::e_ne);
            add_invalid_set2(lexertk::token::e_gte);
            add_invalid_set2(lexertk::token::e_lt);
            add_invalid_set2(lexertk::token::e_gt);
            add_invalid_set2(lexertk::token::e_eq);
            add_invalid_set2(lexertk::token::e_comma);
            add_invalid_set2(lexertk::token::e_div);
            add_invalid_set2(lexertk::token::e_mul);
            add_invalid_set2(lexertk::token::e_mod);
            add_invalid_set2(lexertk::token::e_pow);
            add_invalid_set2(lexertk::token::e_colon);
         }
         ...
         bool operator()(const lexertk::token& t0, const lexertk::token& t1)
         {
            ...
            if (invalid_bracket_check(t0.type,t1.type))
               error_list_.push_back(std::make_pair(t0.position,t1.position));
      ...
      private:
         ...
         void add_invalid_set2(lexertk::token::token_type t)
         {
            add_invalid(t,lexertk::token::e_add);
            add_invalid(t,lexertk::token::e_sub);
         }
            ...
            if (details::is_right_bracket(static_cast<char>(base)))
            {
               ...
               else
               {
                  switch (t)
                  {
                     ...
                     case lexertk::token::e_comma  : return true;
                     case lexertk::token::e_colon  : return true;
         ...
         set_t invalid_comb_;
         std::deque<std::pair<int,int> > error_list_;
