...
# 目录自动完成 输入.或者/的时候，会自动提示路径和路径下的文件。非常好用！
...
# 提高开发效率
apm install emmet
# Atom装了expose这个插件之后，mac用户使用shift＋command＋e组合键可以得到意想不到的酷炫！
apm install expose
...
# minimap-find-and-replace	当你想替换单词的时候你会想起ctrl+D，通过这个插件你就可以在缩略图上看到所有你选中的字符串
