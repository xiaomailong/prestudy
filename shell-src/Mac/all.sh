...
# brew install
# bash /Volumes/Work/OpenSource/WaterBolik/prestudy/shell-src/Mac/brew-install.sh
brew update 
brew upgrade

# brew cask install & update
# bash /Volumes/Work/OpenSource/WaterBolik/prestudy/shell-src/Mac/brew-cask.sh

# git clone & update
bash /Volumes/Work/OpenSource/WaterBolik/prestudy/shell-src/Mac/git-update.sh

# npm install -g
# bash /Volumes/Work/OpenSource/WaterBolik/prestudy/shell-src/Mac/npm-install.sh
# cnpm update -g
...
svn update /Volumes/Work/百度云同步盘/SvnWork/GuiDaoJiaoTong
...
svn update /Volumes/Work/百度云同步盘/SvnWork/Solar-8100
svn update /Volumes/Work/百度云同步盘/SvnWork/Solar-8200
svn update /Volumes/Work/百度云同步盘/SvnWork/Solar-8500
