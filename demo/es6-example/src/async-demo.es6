...
(function () {
  ...
  var asyncReadFile = async function () {
    var r1 = await readFile('file/file1.txt');
    console.log(r1.toString());
    var r2 = await readFile('file/file2.txt');
    console.log(r2.toString());
  };
